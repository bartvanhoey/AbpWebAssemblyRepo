...
public class AbpWebAssemblyDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpWebAssemblyDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
